	...
	
{
   $search=$_GET['search_name'];
	$qry="select * from suggest_icon where youricon='$search' ORDER BY 'time' ASC LIMIT 1, 10"; 
	$pagenation_check=1;
}
else
{
            ...
            <div class="dashboard-content">
                <div class="dashboard-hdr">
                    ...
                    <div class="dashboard-hdrLeft">
                        <h5>SUGGESTION-->VIEW SUGGESTION:Page-<?php echo $page; ?></h5>
                    </div>
                        ...
                        <table style="width:100%">
							...
							else
							{
								...
								$count=$from+1;
	                             ...
	                             $qry="select * from `suggest_icon` ORDER BY `suggest_icon`.`id` DESC LIMIT $from, $to "; 
